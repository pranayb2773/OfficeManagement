                    ...
                    <div class="overflow-y-scroll scrollbar-hidden px-5 pt-5 flex-1">
                        ...
                        <div class="chat__box__text-box flex items-end float-right mb-4">
                            ...
                            <div class="bg-theme-25 px-4 py-3 text-white rounded-l-md rounded-t-md">
                                Lorem ipsum sit amen dolor, lorem ipsum sit amen dolor
                                <div class="mt-1 text-xs text-theme-35">1 mins ago</div>
                            </div>
                        ...
                        <div class="chat__box__text-box flex items-end float-right mb-4">
                            ...
                            <div class="bg-theme-25 px-4 py-3 text-white rounded-l-md rounded-t-md">
                                Lorem ipsum sit amen dolor, lorem ipsum sit amen dolor
                                <div class="mt-1 text-xs text-theme-35">59 secs ago</div>
                            </div>
                            <div class="w-10 h-10 hidden sm:block flex-none image-fit relative ml-5">
                                <img alt="Tinker Tailwind HTML Admin Template" class="rounded-full" src="{{ asset('dist/images/' . $fakers[1]['photos'][0]) }}">
                            </div>
                        ...
                        <div class="chat__box__text-box flex items-end float-right mb-4">
                            ...
                            <div class="bg-theme-25 px-4 py-3 text-white rounded-l-md rounded-t-md">
                                Lorem ipsum
                                <div class="mt-1 text-xs text-theme-35">1 secs ago</div>
                            </div>
                            <div class="w-10 h-10 hidden sm:block flex-none image-fit relative ml-5">
                                <img alt="Tinker Tailwind HTML Admin Template" class="rounded-full" src="{{ asset('dist/images/' . $fakers[1]['photos'][0]) }}">
                            </div>
