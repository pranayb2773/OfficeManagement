    ...
    <div class="pos intro-y grid grid-cols-12 gap-5 mt-5">
        ...
        <div class="intro-y col-span-12 lg:col-span-8">
            ...
            <div class="grid grid-cols-12 gap-5 mt-5">
                ...
                <div class="col-span-12 sm:col-span-4 xxl:col-span-3 box bg-theme-25 dark:bg-theme-25 p-5 cursor-pointer zoom-in">
                    <div class="font-medium text-base text-white">Pancake & Toast</div>
                    <div class="text-theme-35 dark:text-gray-400">8 Items</div>
                </div>
                <div class="col-span-12 sm:col-span-4 xxl:col-span-3 box p-5 cursor-pointer zoom-in">
